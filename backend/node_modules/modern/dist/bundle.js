...
function createEmotionStyled(emotion$$1, view) {
  var _createStyled = function createStyled(tag, options) {
    ...
    return function () {
      ...
      function _render() {
        ...
        if (props.className) {
          if (staticClassName === undefined) {
            className += emotion$$1.getRegisteredStyles(classInterpolations, props.className);
          } else {
        ...
        if (staticClassName === undefined) {
          className += emotion$$1.css.apply(this, styles.concat(classInterpolations));
        } else {
...
var Root = /*#__PURE__*/index('button', {
  target: 'ecrpv7u0'
})({
  background: '#ffffff',
  borderRadius: '2px',
...
var Root$1 = /*#__PURE__*/index('article', {
  target: 'e3wjxet0'
})({
...
var Category = /*#__PURE__*/index('span', {
  target: 'e3wjxet2'
})({
  display: 'block',
  fontSize: '14px',
...
var Author = /*#__PURE__*/index('span', {
  target: 'e3wjxet4'
})({
  fontSize: '14px',
  lineHeight: '17px',
